> 原文链接：<https://blog.csdn.net/qq_34449006/article/details/84312550>
...
![Base64](./imgs/24.png "Base64示意图")
<div align=left>
<font color=red>注</font>：如果使用读取txt文件内容的方法时，记得要将这之前的删掉。
<div align=center>

![Base64](./imgs/25.png "Base64示意图")
<div align=left>