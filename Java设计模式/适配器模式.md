...
<div align=center>![静态代理模式结构示意图](./imgs/6.png "静态代理模式结构示意图")

<div align=center>![静态代理模式结构示意图](./imgs/7.png "静态代理模式结构示意图")
<div align=left>
...
<div align=center>![类适配器模式结构示意图](./imgs/8.png "类适配器模式结构示意图")
<div align=left>
...
<div align=center>![对象适配器模式结构示意图](./imgs/9.png "对象适配器模式结构示意图")
<div align=left>
...
<div align=center>![缺省适配器模式结构示意图](./imgs/10.png "缺省适配器模式结构示意图")
<div align=left>
